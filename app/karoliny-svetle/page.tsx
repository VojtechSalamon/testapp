    ...
    <div className="container">
      ...
      <div className="card" style={{ marginBottom: '2rem' }}>
        ...
        <div style={{ 
          ...
          <Link href="/karoliny-svetle/bezpecnost" className="location-card" style={{ textAlign: 'center' }}>
            <h3>Bezpečnost</h3>
          </Link>
          <Link href="/karoliny-svetle/jak-na-to" className="location-card" style={{ textAlign: 'center' }}>
            <h3>Jak na to</h3>
          </Link>
          <Link href="/karoliny-svetle/o-rezidenci" className="location-card" style={{ textAlign: 'center' }}>
            <h3>O rezidenci</h3>
          </Link>
        </div>
      </div>
