  ...
  return (
    <div className="container">
      <div className="header">
        <h1>Karolíny Světlé - Jak na to</h1>
        <nav>
          <Link href="/">Domů</Link>
        </nav>
      </div>
      ...
      <div style={{ marginBottom: '1.5rem', display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
        ...
        <Link href="/karoliny-svetle/jak-na-to" className="btn" style={{ padding: '0.5rem 1rem', fontSize: '0.9rem' }}>
          Jak na to
        </Link>
        <Link href="/karoliny-svetle/o-rezidenci" className="btn btn-secondary" style={{ padding: '0.5rem 1rem', fontSize: '0.9rem' }}>
          O rezidenci
        </Link>
      </div>
      ...
      <div className="card">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
          <h2>Jak na to - Karolíny Světlé</h2>
          <button 
