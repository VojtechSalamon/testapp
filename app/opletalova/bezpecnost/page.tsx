  ...
  return (
    <div className="container">
      ...
      <div style={{ marginBottom: '1.5rem', display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
        ...
        <Link href="/opletalova/bezpecnost" className="btn" style={{ padding: '0.5rem 1rem', fontSize: '0.9rem' }}>
          Bezpečnost
        </Link>
        <Link href="/opletalova/jak-na-to" className="btn btn-secondary" style={{ padding: '0.5rem 1rem', fontSize: '0.9rem' }}>
          Jak na to
        </Link>
        <Link href="/opletalova/o-rezidenci" className="btn btn-secondary" style={{ padding: '0.5rem 1rem', fontSize: '0.9rem' }}>
          O rezidenci
        </Link>
      </div>
