...
export default function NosticovaPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('nosticova-predani-smeny')
    if (saved) {
      try {
        const parsed = JSON.parse(saved)
  ...
  useEffect(() => {
    if (shiftHandovers.length > 0) {
      localStorage.setItem('nosticova-predani-smeny', JSON.stringify(shiftHandovers))
    }
  }, [shiftHandovers])
  ...
  return (
    <div className="container">
      <div style={{ 
        ...
        <Link href="/nosticova/bezpecnost" className="btn" style={{ textAlign: 'center' }}>
          Bezpečnost
        </Link>
        <Link href="/nosticova/jak-na-to" className="btn" style={{ textAlign: 'center' }}>
          Jak na to
        </Link>
        <Link href="/nosticova/o-rezidenci" className="btn" style={{ textAlign: 'center' }}>
          O rezidenci
        </Link>
      </div>
