...
export default function PredaniSmenyPage() {
  ...
  useEffect(() => {
    if (guides.length > 0) {
      localStorage.setItem('nosticova-predani-smeny', JSON.stringify(guides))
    }
  }, [guides])
    ...
    <div className="container">
      ...
      <div className="card" style={{ marginBottom: '2rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
          ...
          >
            {showAddForm ? 'Zrušit' : '+ Přidat předání směny'}
          </button>
        </div>
        ...
        {guides.length === 0 ? (
          <p style={{ color: '#000', textAlign: 'center', padding: '2rem' }}>
            Zatím nejsou žádná předání směny. Klikněte na "Přidat předání směny" pro vytvoření prvního předání směny.
          </p>
        ) : (
